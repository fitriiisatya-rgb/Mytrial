...
<div class="filters" style="margin-bottom:1.5rem;">
  ...
  <a class="btn" href="/import/revenue">Penerimaan</a>
  <a class="btn secondary" href="/import/history">Riwayat Import</a>
  <a class="btn secondary" href="/import/sources">Sumber Data</a>
</div>

<h1>Import Pendapatan</h1>
<p style="color:#6b7280;font-size:.9rem;">Unggah data pendapatan (Revenue) per outlet dalam format CSV atau XLSX.
  Import ini hanya menyimpan data mentah dan hasil normalisasi - tidak ada jurnal akuntansi yang dibuat pada
  langkah ini (jurnal ditangani pada fase terpisah).</p>

<?php if ($error !== null): ?>
  <div class="flash error"><?= e($error) ?></div>
<?php endif; ?>

<form method="post" action="/import/revenue/preview" enctype="multipart/form-data">
  <?= Csrf::field() ?>
  <div class="field">
  ...
  <div class="field">
    ...
    <input type="text" id="source_name" name="source_name" maxlength="255" placeholder="misal: Pendapatan Outlet A - Sept 2026">
  </div>
