...
<p style="color:#6b7280;font-size:.9rem;">Sistem tidak dapat menemukan baris header secara otomatis (atau kolom
  wajib tidak lengkap pada baris yang dipilih). Pilih baris yang berisi judul kolom (Tanggal / Outlet / Kategori /
  Deskripsi / Jumlah / Referensi) dari data di bawah ini.</p>

<form method="post" action="/import/revenue/preview">
  <?= Csrf::field() ?>
  ...
  <div style="margin-top:1rem;">
    ...
    <a class="btn secondary" href="/import/revenue">Batal</a>
  </div>
</form>
